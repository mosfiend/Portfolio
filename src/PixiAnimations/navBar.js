...
export class Navbar extends PIXI.Container {
    ...
    constructor() {
        ...
        this.project2 = new PIXI.Graphics();
        this.project3 = new PIXI.Graphics();

        this.projectBtnTransContainer = new PIXI.Container();
        this.projectBtnTransition1 = new PIXI.Graphics(); // main circle
        this.projectBtnTransition2 = new PIXI.Graphics(); // moving part
        this.projectBtnTransition3 = new PIXI.Graphics(); // moving part
        ...
        this.project2.on('pointerout', () => {
            if (this.activeProject.y !== this.project2.y &&
                (this.activeProject.y === this.project1.y || this.activeProject.y === this.project3.y)) new Tween(this.project2).to({ alpha: 0.3 }, 300).start()
        });
        this.project3.on('pointerout', () => {
            if (this.activeProject.y !== this.project3.y &&
                (this.activeProject.y === this.project1.y || this.activeProject.y === this.project2.y)) new Tween(this.project3).to({ alpha: 0.3 }, 300).start()
        });
