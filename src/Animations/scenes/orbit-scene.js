import {Assets, Graphics, Container, Sprite} from 'pixi.js'
import { Tween, Easing, Group } from "tweedle.js";
import { Manager } from "../manager.js"

export class OrbitScene extends Container {
    constructor(loading) {
        super();
        this.alpha = 0
        ...
        this.circle5 = new Graphics();
        this.circle6 = new Graphics();
        this.circle7 = new Graphics();
        ...
        // if (Loader.shared.progress === 100) { b// I COULD HAVE PLACED A PROMISED DIRECTLY HERE, YOU KNOW ASYNC BETTER THAN ME WHY DIDNT YOU DO THIS
        this.loadAssets()
    ...
    transitionOut() {
        ...
        function fadeOut() {
        return            new Tween(this.scale).to({x:0,y:0},450)
                        .onComplete(()=>{
...
export class skillIcons extends Container {
